...
const seedDB = async () => {
    ...
    console.log('📝 מעדכן תוכניות אימון מפורטות...');
    ...
    for (const p of playersRaw) {
        ...
        users.push({
            ...
            imageUrl: localImage,
            trainingPlan: { 
                shooting: '300 זריקות', // הכותרת
                shootingDrills: defaultDrills, // הפירוט המלא
                fitness: 'אירובי קל', 
                weightTarget: 90 
            },
    ...
    console.log(`✅ בוצע! לכל השחקנים יש כעת את תוכנית ה-300 זריקות המפורטת.`);
    process.exit();
};
